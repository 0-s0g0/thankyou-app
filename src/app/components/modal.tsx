...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div
        id="modalContent"
        className={` fixed p-0 z-30 flex h-[65vh] w-screen sm:w-[420px] sm:w-lg xl:w-xl scroll-mt-0 flex-col items-center hidden-scrollbar rounded-t-2xl bg-pink-light pb-12 duration-200 delay-75 shadow-[0_-8px_12px_4px_rgba(0,0,0,0.3)]
