...
export const Modalsent: React.FC<ModalsentProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div
        id="modalContent"
        className={` fixed top-32 p-0 z-30 flex h-[500px] w-[300px] sm:w-lg xl:w-xl scroll-mt-0 flex-col items-center hidden-scrollbar rounded-2xl bg-white pb-12 duration-200 delay-75 shadow-[0_-8px_12px_4px_rgba(0,0,0,0.3) animate-fade-in-top]
